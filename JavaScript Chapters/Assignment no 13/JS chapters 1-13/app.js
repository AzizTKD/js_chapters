...
// question no 5
// var myCourse = "Web and mobile app application"
// alert(myCourse)
...
// question no 7
// var email = 'abdulaziztkd2003@gmail.com'
...
// question no 2
// var xyz = "You have visted this site 1 time"
// alert(xyz)
...
// document.write("<h3>" + visitorsName + " ordered " + quantity + " T-Shirts on " + productTitle + "</h3>");
...
// var num = "number"
// var sign = " $"
// var variable = "$my_1stVariable"
// document.write( "<h1>" +  "Variables names can only contain " + " " + num  + sign + " and _. for Example :" + variable + "</h1>");

// var sense = "sensitve"
// document.write("Variables names are case" + " " + sense);
...
// var decrement = --a
// document.write(" value after decreament is :" + " " + decrement + "<br>");
// var division = a/3
// document.write("The remainder is:" + " " + division  + "<br>");
...
// var price = 600
// var total = price * 5
// document.write("Total cost to buy 5 ticket to a movie is" + " " + total + " PKR" );
...
//  var quantity2 = 7
//  var charge = 100
//  var total = (item1*quantity1) + (item2*quantity2) + charge

//  document.write("Price of item 1 is" + " " + item1 + "<br>");
//  document.write("Quantity of item 1 is" + " " + quantity1 + "<br>");
//  document.write("Price of item 2 is" + " " + item2 + "<br>");
//  document.write("Quantity of item 2 is" + " " + quantity2 + "<br>");
//  document.write("Shipping Charges is" + " " + charge + "<br>");
//  document.write( "<br>");
...
// document.write(sub1 +  "" + "Marks" +  ""  + "Is" +  "" + marks1 +  "<br>");
// document.write(sub2 +  "" + "Marks" +  ""  + "Is" +  "" + marks2 + "<br>");
// document.write(sub3 +  "" + "Marks" +  ""  + "Is" +  "" + marks3 + "<br>");
...
//     alert("Intger 1 is greater then integer 2");
// }
// else if(integer1<integer2){
//     alert("Intger 1 is Smaller then integer 2");
// }else{
...
//  }
//         if(time>=1700 && time<2700){
//             alert("Good Evening");
//         }
//             if(time<=2100 && time<2350){
//                 alert("Good Night");
//             }
// else{
